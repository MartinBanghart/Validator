...
# Input for Parser
JJ5SY_PLUGIN_MFLD_EX260_TOKEN_MAP = [
    ...
    {"name": "ex260", "pattern": r"S", "length": 1},
    {"name": "si_unit", "pattern": r"(QAN|QBN|NAN|NBN|NCN|NDN|VAN|VBN|DAN|DBN|FAN|FBN|EAN|EBN|GAN|GBN|KAN|CAN|QA|QB|NA|NC|ND|VA|VB|DA|DB|FA|FB|EA|EB|0)", "length": None},
    {"name": "separator", "pattern": r"-", "length": 1},
...
class JJ5SY_PLUGIN_MFLD_EX260_MODEL(BaseModel):
    # How to Order Information
    prefix: Literal['JJ5SY']
    series: Literal['1', '3', '5']
    type: Literal['10']
    ex260: Literal['S']
    si_unit: Literal['QAN','QBN', 'NAN', 'NBN', 'NCN', 'NDN', 'VAN', 'VBN', 'DAN', 'DBN', 'FAN', 'FBN', 'EAN', 'EBN', 'GAN', 'GBN', 'KAN', 'CAN',
                   'QA', 'QB', 'NA', 'NC', 'ND', 'VA', 'VB', 'DA', 'DB', 'FA', 'FB', 'EA', 'EB', '0']
    ...
    def check_conditions(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_MODEL':
        ...
        if self.p_e_port_entry in ('U', 'D') and self.valve_stations in ('11', '12', '13', '14', '15', '16'):
            raise ValueError('P,E Port entry cannot support this many valve stations')
        if self.si_unit in ('QBN', 'QB', 'NBN', 'NB', 'NDN', 'ND', 'VBN', 'VB', 'DBN', 'DB', 'FBN', 'FB', 'EBN', 'EB', 'GBN') and self.valve_stations not in ('02', '03', '04', '05', '06', '07', '08'):
            raise ValueError('SI unit only has 16 outputs and therefore cannot support this many valve stations with standard double wiring')
    ...
    def build_part_number(self) -> str:
        return (
            ...
            f"-{self.type}{self.ex260}{self.si_unit}"
    ...
    def description(self) -> str:
        return (
            f"JSY{self.series}000 {self.valve_stations} STA EX260 MANIFOLD"
        )    
...
#     # ------------------------------------------- MANIFOLD BLOCK -------------------------------------------    
#     _manifold_block: 'JJ5SY_PLUGIN_MFLD_EX260_MODEL.Manifold_Block' = PrivateAttr()
...
#     @property
#     def manifold_block(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_MODEL.Manifold_Block':
...
#     _sup_exh_block_d_side: 'JJ5SY_PLUGIN_MFLD_EX260_MODEL.Sup_Exh_Block_D_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_d_side(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_MODEL.Sup_Exh_Block_D_Side':
...
#     _sup_exh_block_u_side: 'JJ5SY_PLUGIN_MFLD_EX260_MODEL.Sup_Exh_Block_U_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_u_side(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_MODEL.Sup_Exh_Block_U_Side':
