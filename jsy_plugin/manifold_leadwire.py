...
# Input for Parser
JJ5SY_PLUGIN_MFLD_LEADWIRE_TOKEN_MAP = [
    ...
    {"name": "connector_type", "pattern": r"(L1|L2|L3)", "length": 2},
    {"name": "lead_wire_length", "pattern": r"(1|2|3)", "length": 1},
    {"name": "separator", "pattern": r"-", "length": 1},
...
class JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL(BaseModel):
    # How to Order Information
    prefix: Literal['JJ5SY']
    series: Literal['1', '3', '5']
    type: Literal['10']
    connector_type: Literal['L1', 'L2', 'L3']
    lead_wire_length: Literal['1', '2', '3']
    ...
    def check_conditions(self) -> 'JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL':
        ...
        if self.connector_type in ('L2') and self.valve_stations in ('09', '10', '11', '12', '13', '14', '15', '16'):
            raise ValueError('Connector type has too many valve stations selected')
        if self.connector_type in ('L3') and self.valve_stations not in ('02', '03', '04'):
            raise ValueError('Connector type has too many valve stations selected')
        ...
        if self.p_e_port_entry in ('U', 'D') and self.valve_stations in ('11', '12', '13', '14', '15', '16'):
            raise ValueError('P,E Port entry cannout support this many valve stations')
        return self

    def build_part_number(self) -> str:
        return (
            f"{self.prefix}{self.series}"
            f"-{self.type}{self.connector_type}{self.lead_wire_length}"
    ...
    def description(self) -> str:
        return (
            f"JSY{self.series}000 {self.valve_stations} STA LEADWIRE MANIFOLD"
        )
...
#     # ------------------------------------------- MANIFOLD BLOCK -------------------------------------------    
#     _manifold_block: 'JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL.Manifold_Block' = PrivateAttr()
...
#     @property
#     def manifold_block(self) -> 'JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL.Manifold_Block':
...
#     _sup_exh_block_d_side: 'JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL.Sup_Exh_Block_D_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_d_side(self) -> 'JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL.Sup_Exh_Block_D_Side':
...
#     _sup_exh_block_u_side: 'JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL.Sup_Exh_Block_U_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_u_side(self) -> 'JJ5SY_PLUGIN_MFLD_LEADWIRE_MODEL.Sup_Exh_Block_U_Side':
