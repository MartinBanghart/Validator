...
# Input for Parser
JJ5SY_PLUGIN_MFLD_TERMBOX_TOKEN_MAP = [
    ...
    {"name": "connector_type", "pattern": r"(TC|T)", "length": None}, # order matters here due to greedy nature, putting longer patterns is essential as patterns are checked left to right and terminate if match is made
    {"name": "separator", "pattern": r"-", "length": 1},
...
class JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL(BaseModel):
    ...
    def check_conditions(self) -> 'JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL':
        ...
        if self.connector_type in ('T') and self.valve_stations in ('11', '12', '13', '14', '15', '16'):
    ...
    def description(self) -> str:
        return (
            f"JSY{self.series}000 {self.valve_stations} STA TERMINAL BOX MANIFOLD"
        )
...
#     # ------------------------------------------- MANIFOLD BLOCK -------------------------------------------    
#     _manifold_block: 'JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL.Manifold_Block' = PrivateAttr()
...
#     @property
#     def manifold_block(self) -> 'JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL.Manifold_Block':
...
#     _sup_exh_block_d_side: 'JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL.Sup_Exh_Block_D_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_d_side(self) -> 'JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL.Sup_Exh_Block_D_Side':
...
#     _sup_exh_block_u_side: 'JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL.Sup_Exh_Block_U_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_u_side(self) -> 'JJ5SY_PLUGIN_MFLD_TERMBOX_MODEL.Sup_Exh_Block_U_Side':
