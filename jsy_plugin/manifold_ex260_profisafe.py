...
JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_TOKEN_MAP = [
    ...
    {"name": "ex260_profisafe", "pattern": r"S", "length": 1},
    {"name": "si_unit", "pattern": r"(FPN|DPN|0)", "length": None},
    {"name": "separator", "pattern": r"-", "length": 1},
...
class JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL(BaseModel):
    # How to Order Information
    prefix: Literal['JJ5SY']
    series: Literal['1', '3', '5']
    type: Literal['10']
    ex260_profisafe: Literal['S']
    si_unit: Literal['FPN', 'DPN', '0']
    ...
    def check_conditions(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL':
    ...
    def build_part_number(self) -> str:
        return (
            ...
            f"-{self.type}{self.ex260_profisafe}{self.si_unit}"
    ...
    def description(self) -> str:
        return (
            f"JSY{self.series}000 {self.valve_stations} STA EX260 PROFISAFE MANIFOLD"
        ) 
...
#     # ------------------------------------------- MANIFOLD BLOCK -------------------------------------------    
#     _manifold_block: 'JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL.Manifold_Block' = PrivateAttr()
...
#     @property
#     def manifold_block(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL.Manifold_Block':
...
#     _sup_exh_block_d_side: 'JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL.Sup_Exh_Block_D_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_d_side(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL.Sup_Exh_Block_D_Side':
...
#     _sup_exh_block_u_side: 'JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL.Sup_Exh_Block_U_Side' = PrivateAttr()
...
#     @property
#     def sup_exh_block_u_side(self) -> 'JJ5SY_PLUGIN_MFLD_EX260_PROFISAFE_MODEL.Sup_Exh_Block_U_Side':
