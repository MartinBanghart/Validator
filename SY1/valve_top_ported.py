...
SY1_TOP_PORTED_PLUGIN_VALVE_TOKEN_MAP = [
    ...
    {"name": "rated_voltage", "pattern": r"[5]", "length": 1},
    ...
    {"name": "ab_port_size", "pattern": r"(M5|01|02|C2|C3|C4|C6|C8|C10|C12|N1|N3|N7|N9|N11)", "length": None},
...
class SY1_TOP_PORTED_PLUGIN_VALVE_MODEL(BaseModel):
    prefix: Literal['SY']
...
# === Model logical Statements, write conditions specified in How to Order here ===
    ...
    def validate_conditions(self) -> 'SY1_TOP_PORTED_PLUGIN_VALVE_MODEL':
        # ----- ACTUATION TYPE -----
    ...
    def description(self) -> str:
        return f"{self.prefix}{self.series}000 SERIES TOP PORTED PLUGIN VALVE"